  ...
  return (
    <div className="social-panel channels-panel">
      ...
      <p className="social-help">
        MVP: Bluesky, LinkedIn, and Reddit. Connect Bluesky here with handle + app password.
      </p>
      ...
      {showBlueskyForm ? (
        <form className="bluesky-connect-form" onSubmit={handleBlueskySubmit}>
